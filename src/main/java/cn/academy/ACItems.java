...
public class ACItems {
    ...
    public static final ItemACArmor cons_armor_head = new ItemACArmor(EntityEquipmentSlot.HEAD);
    public static final ItemACArmor cons_armor_chest = new ItemACArmor(EntityEquipmentSlot.CHEST);
    public static final ItemACArmor cons_armor_legs = new ItemACArmor(EntityEquipmentSlot.LEGS);
    public static final ItemACArmor cons_armor_feet = new ItemACArmor(EntityEquipmentSlot.FEET);
    ...
    private static void registerItems(RegistryEvent.Register<Item> event) {
        ...
        event.getRegistry().register(windgen_fan);cons_armor_head.setRegistryName("academy:cons_armor_helmet");
        cons_armor_head.setTranslationKey("cons_armor_helmet");
        event.getRegistry().register(cons_armor_head);
        cons_armor_chest.setRegistryName("academy:cons_armor_chest");
        cons_armor_chest.setTranslationKey("cons_armor_chest");
        event.getRegistry().register(cons_armor_chest);
        cons_armor_legs.setRegistryName("academy:cons_armor_leggings");
        cons_armor_legs.setTranslationKey("cons_armor_leggings");
        event.getRegistry().register(cons_armor_legs);
        cons_armor_feet.setRegistryName("academy:cons_armor_boots");
        cons_armor_feet.setTranslationKey("cons_armor_boots");
        event.getRegistry().register(cons_armor_feet);
    ...
    private static void registerItemRenderers() {
        ...
        ModelLoader.setCustomModelResourceLocation(cons_armor_head, 0, new ModelResourceLocation("academy:cons_armor_helmet", "inventory"));
        ModelLoader.setCustomModelResourceLocation(cons_armor_chest, 0, new ModelResourceLocation("academy:cons_armor_chest", "inventory"));
        ModelLoader.setCustomModelResourceLocation(cons_armor_legs, 0, new ModelResourceLocation("academy:cons_armor_leggings", "inventory"));
        ModelLoader.setCustomModelResourceLocation(cons_armor_feet, 0, new ModelResourceLocation("academy:cons_armor_boots", "inventory"));
    }
